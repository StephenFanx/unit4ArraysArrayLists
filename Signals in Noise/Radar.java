...
public class Radar
{
    ...
    public void scan()
    {
        ...
        // !!! add code here !!!
        //
        //step 1: set all cells in the currentScan 2D array to false
        ...
        //step 2: set the location of the monster in the currentScan 2D array
        
        this.setMonsterLocation(monsterLocationRow, monsterLocationCol);
        
        //step 3: inject noise into the grid
        
        this.injectNoise();
        
        //step 4: update the accumulator 2D array based on the state of the currentScan 2D array
        ...
        //step 5: increment the numScans instance variable
